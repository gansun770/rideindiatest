/* ==========================================================================
   icons.js — inline SVG icons (Lucide paths, hand-embedded, no library)
   Usage: icon('map-pin')  ->  returns an <svg> string
          window.hydrateIcons(root)  -> replaces <i data-icon="name"></i>
   ========================================================================== */
(function () {
  "use strict";
  ...
  // Replace <i data-icon="name"></i> placeholders inside a root element
